...
-- AddForeignKey
ALTER TABLE "Node" ADD CONSTRAINT "Node_id_fkey" FOREIGN KEY ("id") REFERENCES "Workflow"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Connection" ADD CONSTRAINT "Connection_id_fkey" FOREIGN KEY ("id") REFERENCES "Workflow"("id") ON DELETE CASCADE ON UPDATE CASCADE;
